...
interface IMovingPointFactory
{
    MovingPoint CreateMovingPoint();
}
...
class MovingPointFactory : IMovingPointFactory
{
    public MovingPoint CreateMovingPoint()
    {
        ...
        return new MovingPoint(x0, a1);
    }
}

class MovingPoint3DFactory : IMovingPointFactory
{
    public MovingPoint CreateMovingPoint()
    {
        ...
        return new MovingPoint3D(x0, y0, z0, a1, a2, a3);
    }
}
...
class Program
{
    static void Main(string[] args)
    {
        int userSelect;
        double t;
        IMovingPointFactory factory = null;
        MovingPoint baseobj = null;
        ...
        do
        {
            ...
            if (userSelect == 0)
            {
                factory = new MovingPointFactory();
            }
            else if (userSelect == 1)
            {
                factory = new MovingPoint3DFactory();
            }
            else
            {
                return;
            ...
            if (factory != null)
            {
                baseobj = factory.CreateMovingPoint();
